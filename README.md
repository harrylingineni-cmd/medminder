...
The US Find Ingredient tab sends only the medicine name entered into that search
...
The companion [Active Ingredient Finder](https://harrylingineni-cmd.github.io/medminder/finder/)
offers the same optional lookup in a browser. Its US search also sends only the
typed medicine name directly to RxNav. The website is hosted on GitHub Pages.
